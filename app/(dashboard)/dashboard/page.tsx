...
export default async function DashboardPage() {
  ...
  const props: DashboardProps = {
    ...
    todaySessions:     (todaySessions ?? []) as unknown as DashboardProps['todaySessions'],
    upcomingSessions:  (upcomingSessions ?? []) as unknown as DashboardProps['upcomingSessions'],
    activeSessions:    (activeSessions  ?? []) as unknown as DashboardProps['activeSessions'],
