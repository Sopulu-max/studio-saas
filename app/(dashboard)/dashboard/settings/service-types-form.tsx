...
import type { ServiceTypeConfig } from '@/lib/studio-config'
...
export default function ServiceTypesForm({ initial }: { initial: ServiceTypeConfig[] }) {
  const [types, setTypes]       = useState<ServiceTypeConfig[]>(initial)
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
        <div>
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-3)', margin: 0 }}>
            What media services your studio offers. A session can be Photography, Videography, or both.
          </p>
        </div>
